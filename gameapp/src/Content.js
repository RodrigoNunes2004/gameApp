function Content()
{
    ...
    return(
    <>
    <h1 className="display-1">Reacyt Game Application</h1>
    <div className="row">
    <div className="card col me-3 shadow">
        <img className= "card-img-top" src="images/borderlands3.jpeg" alt="Borderland" />
        <div className="card-body">
            <h5 className="card-title">Borderland 3</h5>
    ...
    <div className="card col me-3 shadow">
        <img className= "card-img-top" src="images/octopath.jpeg" alt="Borderland" />
        <div className="card-body">
            <h5 className="card-title">Borderland 3</h5>
            <p className="card-text">
    ...
    <div className="card col me-3 shadow">
        <img className= "card-img-top" src="images/reddead2.jpeg" alt="Borderland" />
        <div className="card-body">
            <h5 className="card-title">Borderland 3</h5>
            <p className="card-text">
